...
|                           |                                                           |
| ------------------------- | --------------------------------------------------------- |
| **Packaged app version**  | `0.3.16` (see [`dozzle/config.yaml`](dozzle/config.yaml)) |
| **Bundled Dozzle binary** | `v11.0.1` (see [`dozzle/Dockerfile`](dozzle/Dockerfile))  |
...
[release-shield]: https://img.shields.io/badge/version-v0.3.16-blue.svg
[release]: https://github.com/Erreur32/homeassistant-dozzle/releases/tag/v0.3.16
